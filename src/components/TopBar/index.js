                    ...
                    <div className="action-container">
                        {isSignedIn ? (
                            <div className="d-flex align-items-center gap-2">
                                <span className="text-black fw-semibold">{auth.user?.email}</span>
                                <Button variant="outline-light" size="sm" onClick={handleLogout} className="sign-in-btn rounded-pill px-4 py-2">
                                    Log out
                                </Button>
                            </div>
                        ) : (
